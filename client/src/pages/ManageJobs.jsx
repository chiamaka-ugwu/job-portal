  ...
  return (
    <div className="container p-4 max-w-5xl">
        ...
        <table className="min-w-full bg-white border border-gray-200 max-sm:text-sm">
          <thead>
            <tr>
              ...
              <th className="py-2 px-4 border-b text-left">Job Ttle</th>
      ...
      <div className='mt-4 flex justify-end'>
        <button onClick={()=>navigate('/dashboard/add-job')} className='bg-blue-500 text-white rounded px-4 py-2'>Add new job</button>
      </div>
    </div>
  );
}
